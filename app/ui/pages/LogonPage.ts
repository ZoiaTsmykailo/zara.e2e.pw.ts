...
export class LogonPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.logonRegistrationButtonLocator = page.locator(
      'button[data-qa-id="logon-view-alternate-button"]'
    );
    this.emailErrorLocator = page.locator(
      '//div[contains(@class, "form__column")]//div[contains(@class, "form-input-error")]'
    );
    this.emailInputLocator = page.locator(
      'input[data-qa-input-qualifier="email"]'
    );
    this.passwordInputLocator = page.locator(
      'input[data-qa-input-qualifier="password"]'
    );
    this.firstNameInputLocator = page.locator(
      'input[data-qa-input-qualifier="firstName"]'
    );
    this.lastNameInputLocator = page.locator(
      'input[data-qa-input-qualifier="lastName"]'
    );
    this.signUpSubmitButtonLocator = page.locator(
      'button[data-qa-action="sign-up-submit"]'
    );
  }
