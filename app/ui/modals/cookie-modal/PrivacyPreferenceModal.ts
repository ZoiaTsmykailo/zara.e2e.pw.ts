...
export class PrivacyPreferenceModal {
    ...
    constructor(page: Page) {
        ...
        this.analysisSwitch = page.locator('label.ot-switch[for="ot-group-id-C0002"] .ot-switch-nob');
        this.analysisStatus = page.locator('label.ot-switch[for="ot-group-id-C0002"] + span.ot-label-status');
        this.advertisingCookies = page.locator('#ot-header-id-C0003');
        this.advertisingSwitch = page.locator('label.ot-switch[for="ot-group-id-C0003"] .ot-switch-nob');
        this.advertisingStatus = page.locator('label.ot-switch[for="ot-group-id-C0003"] + span.ot-label-status');
        this.confirmMyChoicesButton = page.locator('button.save-preference-btn-handler.onetrust-close-btn-handler');
